 ...
 */
sap.ui.define(["jquery.sap.global", "sap/m/Slider", "sap/ui/core/InvisibleText"],
    function (jQuery, Slider, InvisibleText) {
        "use strict";

        var RangeSlider = Slider.extend("sap.ui.tum.grid.cpu.custom_controls.RangeSliderNoLabel", /** @lends sap.m.RangeSlider.prototype */ {
            metadata: {
                library: "sap.ui.tum.grid.cpu.custom_controls",
                properties: {
                    /**
